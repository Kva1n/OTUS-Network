...
R22(config-router-af)#network 2001:BB:FF:C10::/64
R22(config-router-af)#network 2001:BB:FF:E5::/64
R22(config-router-af)#network 2001:BB:FF:E6::/64
R22(config-router-af)#neighbor 2001:BB:FF:C10:CE:1001:D14:E02 activate
R22(config-router-af)#neighbor 2001:BB:FF:E5:0:301:D21:E01 activate
R22(config-router-af)#neighbor 2001:BB:FF:E6:0:520:D24:E00 activate
```
...
R21(config-router-af)#network 2001:BB:FF:E5::0/64
R21(config-router-af)#network 2001:BB:FF:C50::0/64
R21(config-router-af)#network 2001:BB:FF:E20::0/64
R21(config-router-af)#neighbor 2001:BB:FF:E20:0:520:D24:E00 activate
R21(config-router-af)#neighbor 2001:BB:FF:C50:CE:1001:D15:E02 activate
R21(config-router-af)#neighbor 2001:BB:FF:E5:0:101:D22:E01 activate
```
...
R23(config-router-af)#network 2001:BB:FF:E6::/64
R23(config-router-af)#neighbor 2001:BB:FF:E6:0:101:D22:E01 activate
```
...
R24(config-router-af)#network 2001:BB:FF:C120::0/64
R24(config-router-af)#network 2001:BB:FF:E20::0/64
R24(config-router-af)#neighbor 2001:BB:FF:C120:CE:2042:D18:E02 activate
R24(config-router-af)#neighbor 2001:BB:FF:E20:0:301:D21:E02 activate
```
...
R26(config-router-af)#network 2001:BB:FF:C130::/64
R26(config-router-af)#neighbor 2001:BB:FF:C130:CE:2042:D18:E03 activate
```
...
R14(config-router-af)#network 2001:BB:FF:C10::/64
R14(config-router-af)#neighbor 2001:BB:FF:C10:0:101:D22:E00 activate
```
...
R15(config-router-af)#network 2001:BB:FF:C50::/64
R15(config-router-af)#neighbor 2001:BB:FF:C50:0:301:D21:E00 activate
```
...
R18(config-router-af)#network 2001:BB:FF:C120::0/64
R18(config-router-af)#network 2001:BB:FF:C130::0/64
R18(config-router-af)#neighbor 2001:BB:FF:C120:0:520:D24:E03 activate
R18(config-router-af)#neighbor 2001:BB:FF:C130:0:520:D26:E03 activate
```
...
```
R18#ping 2001:BB:FF:C50:CE:1001:D15:E02
Type escape sequence to abort.
Sending 5, 100-byte ICMP Echos to 2001:BB:FF:C50:CE:1001:D15:E02, timeout is 2 seconds:
!!!!!
Success rate is 100 percent (5/5), round-trip min/avg/max = 1/1/2 ms
R18#ping 2001:BB:FF:C10:CE:1001:D14:E02
Type escape sequence to abort.
Sending 5, 100-byte ICMP Echos to 2001:BB:FF:C10:CE:1001:D14:E02, timeout is 2 seconds:
!!!!!
Success rate is 100 percent (5/5), round-trip min/avg/max = 1/1/1 ms
