...
##### 1. Настройте SW2 в качестве сервера VTP в домене **CCNA** с паролем **cisco**.
...
##### 2. Настройте SW1 и SW3 в качестве  клиентов VTP в домене **CCNA** с паролем**cisco**. Конфигурации VTP приведены ниже.
...
##### 3. Проверьте конфигурации VTP, введя команду **show vtp status** на всех 		коммутаторах. Статус VTP для SW3 приведен ниже.
...
##### 1. Настройте динамические магистральные каналы между SW1 и SW2.
...
##### 2. Настройте статический магистральный канал между SW1 и SW3.
...
#### 2. Проверьте обновления 	VTP на коммутаторах SW1 и SW3.
...
#### 1. Переведите VTP на 	коммутаторе SW1 в прозрачный режим.
...
#### 2. Настройте сеть VLAN расширенного диапазона на коммутаторе SW1.
